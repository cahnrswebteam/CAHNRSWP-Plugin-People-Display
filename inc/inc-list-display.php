<div class="wsuprofileTableRowData <?php echo $class; ?>"> 
   	...
   	<div class="wsuprofileTableCell name"><a class="profile-link" data-id="<?php echo $profile->profile_ID;?>" data-name="<?php echo $profile->profile_title->rendered;?> href="#"><?php  echo $profile->profile_first_name; ?> <?php  echo $profile->profile_last_name; ?></a>
